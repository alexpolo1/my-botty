...
class Config:
    ...
    def load_data(self):
        ...
        self.char = {
            ...
            "buff_with_cta": bool(int(self._select_val("char", "buff_with_cta"))),
            ...
            "cta_casting_frames": int(self._select_val("char", "cta_casting_frames")),
            "attack_frames": int(self._select_val("char", "attack_frames")),
